      ...
      <div className="mx-auto flex w-10/12 flex-row flex-wrap justify-center gap-4 rounded-2xl py-6 font-semibold">
        <div className="m-auto flex w-full flex-row items-center justify-around">
          ...
          <div className="flex w-full flex-row items-center justify-end gap-2 lg:gap-6">
            ...
            <div className="flex w-auto animate-pulso3 rounded-xl border-2 border-black bg-pokewhite p-3 text-center text-sm font-normal text-black md:top-56 md:w-4/12 lg:right-20 lg:w-6/12 lg:text-base">
              <span>
            ...
            <div className="w-7/12 lg:w-4/12">
              {/* BOTON PARA PT 2 */}
              <Link to="/stage2">
