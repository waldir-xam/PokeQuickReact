...
const Header = () => {
  ...
  return (
    <header className="flex-colrow mx-auto flex w-11/12 items-center justify-between py-4 md:w-full lg:mx-auto lg:flex lg:max-w-7xl lg:justify-around px-6">
      <div>
        <button
          className="animate animate-pulso-custom h-12 w-12 animate-pulso rounded bg-pokeball bg-cover bg-no-repeat duration-300 hover:animate-pulso"
          id="menuBtn"
      ...
      <figure className="">
        <Link to="/">
          <img className="h-20" src={pokelogo} alt="logo" />
        </Link>
      </figure>
      <div className="flex animate-pulso flex-row items-center font-title font-medium  text-white hover:text-black">
        <span className="hidden px-2 font-semibold md:block lg:block xl:block">
          BGM ON/OFF
        </span>
